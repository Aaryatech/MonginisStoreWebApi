...
public interface POReportDetailRepo extends JpaRepository<POReportDetail, Integer> {
	@Query(value = "SELECT *,i.item_code,i.item_desc as item_name, ih.ind_m_date FROM po_detail ,m_item i ,indtrans id,indent ih WHERE po_detail.po_id IN(:poIdList)  AND i.item_id=po_detail.item_id AND "
