...
public interface ItemListWithCurrentStockRepository extends JpaRepository<ItemListWithCurrentStock, Integer>{
	...
	@Query(value = ("SELECT\r\n" + 
			...
			"        coalesce(0) AS issue_return_qty \r\n" + 
			"    FROM\r\n" + 
			"        m_item\r\n" + 
			"    where\r\n" + 
			"        m_item.is_used=1\r\n" + 
			"        and m_item.cat_id=:catId"), nativeQuery = true)
	List<ItemListWithCurrentStock> getItemListByCatIdWithStock(@Param("fromDate")String fromDate,
	...
	ItemListWithCurrentStock getItemListByItemIdWithStock(@Param("fromDate")String fromDate,
